...
const PALETTE_MAP: Record<string, string> = {
  ...
  '#1f2a44': '#f0f3f8',
  '#0f172a': '#8f98a8',
  'rgba(103,232,249,0.18)': 'rgba(42, 103, 183, 0.11)',
  'rgba(103,232,249,0.15)': 'rgba(42, 103, 183, 0.08)',
  'rgba(167,243,208,0.18)': 'rgba(47, 127, 87, 0.11)',
  'rgba(253,164,175,0.18)': 'rgba(155, 79, 98, 0.11)',
  'rgba(252,211,77,0.18)': 'rgba(138, 106, 36, 0.11)',
};
