...
> = {
  ...
  'Skraaplan og friktion': {
    patternIds: ['pattern-forces'],
    formulaIds: ['incline-components', 'friction-kinetic', 'newton-second-law'],
  ...
  'Relativ hastighed og vektorer': {
    ...
    formulaIds: ['relative-velocity', 'vector-addition', 'angle-between-vectors'],
    exampleIds: ['ex-relative-wind'],
  },
  'Gravitation og cirkelbevagelse': {
    patternIds: ['pattern-orbit', 'pattern-circular-motion'],
    formulaIds: ['universal-gravitation', 'orbital-speed', 'orbital-period', 'centripetal-force'],
    exampleIds: ['ex-satellite', 'ex-gravity-force', 'ex-circular-turn'],
  },
  'Rotation og inertimoment': {
    patternIds: ['pattern-rotation'],
    formulaIds: ['linear-angular-speed', 'torque', 'rotational-newton', 'parallel-axis-theorem'],
  ...
  'Arbejde og energibevarelse': {
    ...
    formulaIds: ['work-constant-force', 'work-energy-theorem', 'mechanical-energy', 'power'],
  ...
  'Temperatur, varme og faseovergange': {
    ...
    formulaIds: ['heat-capacity', 'latent-heat', 'thermal-expansion-linear', 'heat-conduction-r'],
  ...
  'pV-processer og 1. hovedsaetning': {
    ...
    formulaIds: ['first-law', 'gas-work', 'isobaric-work', 'isothermal-ideal-gas', 'adiabatic-process'],
